...
/*
  ╔══════════════════════════════════════════════════════════════╗
  ║  만약에 투자했다면 — Redesigned                                 ║
  ║  Design: Finance Premium + Emerald Accent                    ║
  ║  Palette: Deep charcoal + green profit / coral loss          ║
  ╚══════════════════════════════════════════════════════════════╝
*/

const ASSETS = [
  { id:"samsung",name:"삼성전자",emoji:"📱",cat:"kr_stock",color:"#1428a0",
    prices:[{d:"2014-01",p:24600},{d:"2015-01",p:26400},{d:"2016-01",p:23200},{d:"2017-01",p:38200},{d:"2018-01",p:51900},{d:"2019-01",p:43000},{d:"2020-01",p:55200},{d:"2020-06",p:52600},{d:"2021-01",p:81000},{d:"2021-06",p:80000},{d:"2022-01",p:74400},{d:"2022-06",p:59800},{d:"2023-01",p:60600},{d:"2023-06",p:71400},{d:"2024-01",p:74200},{d:"2024-06",p:81000},{d:"2025-01",p:53600}]},
  { id:"sk-hynix",name:"SK하이닉스",emoji:"💾",cat:"kr_stock",color:"#e4002b",
    prices:[{d:"2014-01",p:34500},{d:"2015-01",p:46200},{d:"2016-01",p:27700},{d:"2017-01",p:45800},{d:"2018-01",p:75000},{d:"2019-01",p:60800},{d:"2020-01",p:96200},{d:"2021-01",p:130000},{d:"2022-01",p:119000},{d:"2022-06",p:89200},{d:"2023-01",p:80000},{d:"2023-06",p:120000},{d:"2024-01",p:141000},{d:"2024-06",p:214000},{d:"2025-01",p:178000}]},
  { id:"kakao",name:"카카오",emoji:"💬",cat:"kr_stock",color:"#fee500",
    prices:[{d:"2017-01",p:88000},{d:"2018-01",p:140000},{d:"2019-01",p:115000},{d:"2020-01",p:170000},{d:"2020-06",p:312000},{d:"2021-01",p:460000},{d:"2021-06",p:530000},{d:"2022-01",p:395000},{d:"2022-06",p:230000},{d:"2023-01",p:195000},{d:"2023-06",p:200000},{d:"2024-01",p:170000},{d:"2024-06",p:145000},{d:"2025-01",p:120000}]},
  { id:"naver",name:"네이버",emoji:"🟢",cat:"kr_stock",color:"#03c75a",
    prices:[{d:"2014-01",p:145000},{d:"2015-01",p:170000},{d:"2016-01",p:155000},{d:"2017-01",p:180000},{d:"2018-01",p:195000},{d:"2019-01",p:125000},{d:"2020-01",p:180000},{d:"2021-01",p:345000},{d:"2021-06",p:410000},{d:"2022-01",p:340000},{d:"2022-06",p:210000},{d:"2023-01",p:210000},{d:"2023-06",p:220000},{d:"2024-01",p:230000},{d:"2025-01",p:195000}]},
  { id:"kospi",name:"KOSPI",emoji:"📈",cat:"kr_index",color:"#0066b3",
    prices:[{d:"2014-01",p:1967},{d:"2015-01",p:1916},{d:"2016-01",p:1918},{d:"2017-01",p:2067},{d:"2018-01",p:2470},{d:"2019-01",p:2065},{d:"2020-01",p:2175},{d:"2020-06",p:2152},{d:"2021-01",p:3064},{d:"2021-06",p:3285},{d:"2022-01",p:2750},{d:"2022-06",p:2332},{d:"2023-01",p:2399},{d:"2023-06",p:2586},{d:"2024-01",p:2556},{d:"2024-06",p:2804},{d:"2025-01",p:2400}]},
  { id:"sp500",name:"S&P 500",emoji:"🇺🇸",cat:"us_index",color:"#b22234",
    prices:[{d:"2014-01",p:1848},{d:"2015-01",p:2059},{d:"2016-01",p:1940},{d:"2017-01",p:2279},{d:"2018-01",p:2824},{d:"2019-01",p:2607},{d:"2020-01",p:3278},{d:"2020-06",p:3100},{d:"2021-01",p:3714},{d:"2021-06",p:4298},{d:"2022-01",p:4516},{d:"2022-06",p:3785},{d:"2023-01",p:4077},{d:"2023-06",p:4450},{d:"2024-01",p:4770},{d:"2024-06",p:5460},{d:"2025-01",p:5880}]},
  { id:"nasdaq",name:"나스닥",emoji:"💻",cat:"us_index",color:"#0096d6",
    prices:[{d:"2014-01",p:4143},{d:"2015-01",p:4757},{d:"2016-01",p:4614},{d:"2017-01",p:5614},{d:"2018-01",p:7411},{d:"2019-01",p:6636},{d:"2020-01",p:9150},{d:"2021-01",p:13070},{d:"2021-06",p:14504},{d:"2022-01",p:14240},{d:"2022-06",p:11028},{d:"2023-01",p:11510},{d:"2023-06",p:13787},{d:"2024-01",p:15164},{d:"2024-06",p:17862},{d:"2025-01",p:19627}]},
  { id:"apple",name:"애플",emoji:"🍎",cat:"us_stock",color:"#555",
    prices:[{d:"2014-01",p:19.3},{d:"2015-01",p:27},{d:"2016-01",p:24.2},{d:"2017-01",p:29.6},{d:"2018-01",p:41.6},{d:"2019-01",p:38.5},{d:"2020-01",p:77.4},{d:"2021-01",p:131},{d:"2021-06",p:137},{d:"2022-01",p:175},{d:"2022-06",p:137},{d:"2023-01",p:143},{d:"2023-06",p:193},{d:"2024-01",p:185},{d:"2024-06",p:210},{d:"2025-01",p:237}]},
  { id:"tesla",name:"테슬라",emoji:"🚗",cat:"us_stock",color:"#cc0000",
    prices:[{d:"2017-01",p:16.6},{d:"2018-01",p:23.3},{d:"2019-01",p:20},{d:"2020-01",p:28.7},{d:"2020-06",p:68},{d:"2021-01",p:264},{d:"2021-06",p:226},{d:"2022-01",p:360},{d:"2022-06",p:224},{d:"2023-01",p:128},{d:"2023-06",p:261},{d:"2024-01",p:225},{d:"2024-06",p:197},{d:"2025-01",p:378}]},
  { id:"bitcoin",name:"비트코인",emoji:"₿",cat:"crypto",color:"#f7931a",
    prices:[{d:"2014-01",p:800},{d:"2015-01",p:220},{d:"2016-01",p:430},{d:"2017-01",p:1000},{d:"2017-06",p:2500},{d:"2018-01",p:13000},{d:"2018-06",p:6200},{d:"2019-01",p:3500},{d:"2019-06",p:11000},{d:"2020-01",p:7200},{d:"2020-06",p:9100},{d:"2021-01",p:33000},{d:"2021-06",p:35000},{d:"2022-01",p:38000},{d:"2022-06",p:19000},{d:"2023-01",p:23000},{d:"2023-06",p:30000},{d:"2024-01",p:42000},{d:"2024-06",p:62000},{d:"2025-01",p:94000}]},
  { id:"ethereum",name:"이더리움",emoji:"⟠",cat:"crypto",color:"#627eea",
    prices:[{d:"2017-01",p:8},{d:"2017-06",p:300},{d:"2018-01",p:1100},{d:"2018-06",p:430},{d:"2019-01",p:110},{d:"2020-01",p:130},{d:"2020-06",p:230},{d:"2021-01",p:1300},{d:"2021-06",p:2300},{d:"2022-01",p:2900},{d:"2022-06",p:1050},{d:"2023-01",p:1570},{d:"2023-06",p:1880},{d:"2024-01",p:2300},{d:"2024-06",p:3400},{d:"2025-01",p:3300}]},
  { id:"gold",name:"금",emoji:"🥇",cat:"commodity",color:"#d4a017",
    prices:[{d:"2014-01",p:1240},{d:"2015-01",p:1185},{d:"2016-01",p:1097},{d:"2017-01",p:1210},{d:"2018-01",p:1340},{d:"2019-01",p:1290},{d:"2020-01",p:1580},{d:"2020-06",p:1780},{d:"2021-01",p:1860},{d:"2022-01",p:1830},{d:"2022-06",p:1810},{d:"2023-01",p:1920},{d:"2023-06",p:1930},{d:"2024-01",p:2050},{d:"2024-06",p:2330},{d:"2025-01",p:2770}]},
];
...
export default function InvestSim() {
  ...
  const selectAsset = (a) => { setAsset(a); setStartD(a.prices[0].d.slice(0, 7)); setPg("sim"); };

  const run = useCallback(() => {
    if (!asset) return;
    const last = asset.prices[asset.prices.length - 1].d;
    if (simType === "lump") {
      const inv = parseFloat(amount) * 1e4; if (!inv || inv <= 0) return;
      const sp = getPrice(asset, startD + "-01"), ep = getPrice(asset, last);
      const shares = inv / sp, cv = shares * ep, profit = cv - inv, ret = ((cv / inv) - 1) * 100;
      const chart = []; const s = new Date(startD + "-01"), e = new Date(last), cur = new Date(s);
      ...
      setRes({ type: "lump", inv, cv: Math.round(cv), profit: Math.round(profit), ret, cagr, chart, yrs: yrs.toFixed(1) });
    } else {
      const mo = parseFloat(monthlyAmt) * 1e4; if (!mo || mo <= 0) return;
      const s = new Date(startD + "-01"), e = new Date(last), chart = []; let ti = 0, ts = 0, cur = new Date(s);
      ...
      const ep = getPrice(asset, last), cv = ts * ep, profit = cv - ti, ret = ((cv / ti) - 1) * 100;
      setRes({ type: "dca", inv: Math.round(ti), cv: Math.round(cv), profit: Math.round(profit), ret, chart, avgP: ti / ts, months: chart.length });
    }
    setPg("result");
  }, [asset, simType, amount, startD, monthlyAmt]);
  ...
  const saveImg = useCallback(() => {
    ...
    x.fillStyle = pc; x.font = "bold 56px sans-serif"; x.fillText(`${res.profit >= 0 ? "+" : ""}${fm(res.profit)}원`, 320, 170);
    x.font = "bold 22px sans-serif"; x.fillText(`수익률 ${res.ret >= 0 ? "+" : ""}${res.ret.toFixed(1)}%`, 320, 210);
    x.fillStyle = "#888"; x.font = "14px sans-serif"; x.fillText(`현재 가치: ${ff(res.cv)}원`, 320, 250);
  ...
  const dates = asset ? asset.prices.map(p => p.d.slice(0, 7)) : [];
  const pc = res?.profit >= 0 ? "#2dd4bf" : "#f87171";
        ...
        {pg === "home" && (
          <div className="si">
            ...
            <div className="mt-6 space-y-2" style={{ color: "rgba(255,255,255,.08)", fontSize: 10.5, lineHeight: 1.9, borderTop: "1px solid rgba(255,255,255,.03)", paddingTop: 16 }}>
              <h2 style={{ color: "rgba(255,255,255,.12)", fontSize: 11, fontWeight: 700 }}>투자 시뮬레이터</h2>
              <p>과거 특정 시점에 투자했다면 현재 얼마가 되었을지 계산합니다. 일시불과 적립식(DCA) 두 가지 방식을 지원합니다.</p>
            </div>
          </div>
        )}
        ...
        {pg === "sim" && asset && (
          <div className="py-5 si">
            ...
            <div className="space-y-3">
              ...
              <div>
                <label className="block text-[9px] uppercase tracking-[0.2em] mb-2 ml-0.5" style={{ color: "rgba(255,255,255,.2)" }}>투자 시작 시점</label>
                <select value={startD} onChange={e => setStartD(e.target.value)}
                  className="w-full rounded-2xl px-5 py-3.5 text-[13px] appearance-none transition-all"
                  style={{ background: "rgba(255,255,255,.025)", border: "1px solid rgba(255,255,255,.06)", color: "#e2e8f0" }}>
                  {dates.map(d => (<option key={d} value={d}>{d.replace("-", "년 ")}월</option>))}
                </select>
              </div>
            </div>
        ...
        {pg === "result" && res && asset && (
          <div className="py-5 si">
            <div className="text-center mb-1">
              <span className="text-[11px]" style={{ color: "rgba(255,255,255,.2)" }}>{asset.emoji} {asset.name} · {res.type === "lump" ? "일시불" : "적립식"}</span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 mb-5">
              {[
                ...
                [res.type === "lump" ? "CAGR" : "평균 매입가", res.type === "lump" ? `${res.cagr?.toFixed(1)}%` : fm(Math.round(res.avgP || 0)), "#a78bfa"],
              ].map(([l, v, c]) => (
            ...
            <div className="gl rounded-2xl p-4 mb-5">
              <h3 className="text-[9px] uppercase tracking-[0.2em] mb-3" style={{ color: "rgba(255,255,255,.12)" }}>Value Chart</h3>
            ...
            <div className="grid grid-cols-3 gap-2.5 mb-5">
              {[["다시하기", () => { setPg("sim"); setRes(null); }], ["📸 저장", saveImg], ["공유", () => { const t = `${asset.name}에 ${fm(res.inv)}원 → ${res.profit >= 0 ? "+" : ""}${ff(res.profit)}원 (${res.ret.toFixed(1)}%)`; if (navigator.share) navigator.share({ title: "투자 시뮬", text: t, url: location.href }); else { navigator.clipboard.writeText(t); alert("복사됨!"); } }]].map(([l, fn], i) => (
            ...
            {/* Other assets */}
            <div className="gl rounded-2xl p-4 mb-5">
              <h3 className="text-[9px] uppercase tracking-[0.2em] mb-3" style={{ color: "rgba(255,255,255,.12)" }}>Other Assets</h3>
