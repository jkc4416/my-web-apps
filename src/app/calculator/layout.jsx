...
export const metadata = {
  ...
  description:
    "연봉 실수령액 계산, BMI 체질량지수, 단위 변환, 퍼센트 계산, 할인율 계산 등 일상에서 필요한 모든 계산을 한 곳에서 무료로 이용하세요. 설치 없이 브라우저에서 바로 사용 가능.",
  keywords: ["연봉 계산기", "실수령액 계산", "BMI 계산기", "단위 변환기", "할인 계산기", "퍼센트 계산기", "무료 계산기", "온라인 계산기"],
  openGraph: {
    title: "만능 계산기 — 연봉, BMI, 단위변환, 할인 계산",
    description: "일상에서 필요한 다양한 계산을 한 곳에서 무료로 해결하세요.",
    type: "website",
    url: "https://www.funappbox.com/calculator",
  },
