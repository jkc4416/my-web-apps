...
export const metadata = {
  ...
  keywords: ["지뢰찾기", "마인스위퍼", "Minesweeper", "온라인 게임", "퍼즐 게임", "무료 게임", "브라우저 게임"],
  openGraph: { title: "지뢰찾기 — 온라인 마인스위퍼", description: "클래식 지뢰찾기 — 3단계 난이도", type: "website", url: "https://www.funappbox.com/minesweeper" },
