...
export const metadata = {
  ...
  keywords: ["나이 계산기", "만 나이 계산", "띠 계산", "별자리 찾기", "생일 계산", "탄생석", "나이 몇살"],
  openGraph: { title: "나이 계산기", description: "만 나이, 띠, 별자리, 생일까지 한번에", type: "website", url: "https://www.funappbox.com/age-calc" },
