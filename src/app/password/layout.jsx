...
export const metadata = {
  ...
  keywords: ["비밀번호 생성기", "비밀번호 만들기", "랜덤 비밀번호", "강력한 비밀번호", "패스워드 생성", "보안 비밀번호"],
  openGraph: { title: "비밀번호 생성기", description: "안전한 랜덤 비밀번호 즉시 생성", type: "website", url: "https://www.funappbox.com/password" },
