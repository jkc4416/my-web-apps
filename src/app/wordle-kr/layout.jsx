...
export const metadata = {
  ...
  keywords: ["워들", "한글 워들", "Wordle", "단어 맞추기", "단어 게임", "매일 게임", "퍼즐 게임"],
  openGraph: { title: "한글 워들 — 단어 맞추기", description: "매일 새로운 한글 단어를 맞춰보세요!", type: "website", url: "https://www.funappbox.com/wordle-kr" },
