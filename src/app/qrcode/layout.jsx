...
export const metadata = {
  ...
  keywords: ["QR코드 생성기", "QR코드 만들기", "무료 QR코드", "QR 생성", "URL QR코드", "와이파이 QR"],
  openGraph: { title: "QR코드 생성기 — 무료 QR코드 만들기", description: "텍스트, URL을 QR코드로 무료 변환", type: "website", url: "https://www.funappbox.com/qrcode" },
