...
export const metadata = {
  ...
  keywords: ["단위 변환기", "길이 변환", "무게 변환", "온도 변환", "평 계산", "인치 센티미터", "파운드 킬로그램"],
  openGraph: { title: "단위 변환기", description: "길이, 무게, 온도, 넓이 즉시 변환", type: "website", url: "https://www.funappbox.com/unit-convert" },
