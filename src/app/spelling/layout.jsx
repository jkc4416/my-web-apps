...
export const metadata = {
  ...
  description:
    "왠지 vs 웬지, 됬다 vs 됐다, 안돼 vs 안되 — 자주 틀리는 한국어 맞춤법을 퀴즈로 재미있게 마스터하세요. 단계별 난이도, 점수 기록, 해설까지. 무료 맞춤법 테스트.",
  keywords: ["맞춤법", "맞춤법 퀴즈", "맞춤법 테스트", "한국어 맞춤법", "헷갈리는 맞춤법", "됬다 됐다", "왠지 웬지", "띄어쓰기", "국어 퀴즈"],
  openGraph: {
    title: "맞춤법 퀴즈 — 헷갈리는 한국어 맞춤법 테스트",
    description: "자주 틀리는 한국어 맞춤법을 퀴즈로 마스터하세요.",
    type: "website",
    url: "https://www.funappbox.com/spelling",
  },
